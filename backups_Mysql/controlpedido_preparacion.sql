...
CREATE TABLE `preparacion` (
  ...
  UNIQUE KEY `idpedido_UNIQUE` (`idpedido`) /*!80000 INVISIBLE */,
  KEY `fk_preparacion_pedido` (`idpedido`,`fallo`,`revision`,`picking`),
  CONSTRAINT `fk_preparacion_pedido` FOREIGN KEY (`idpedido`) REFERENCES `pedido` (`idpedido`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='tabla de pedidos preparados';
